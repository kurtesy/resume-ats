...
# Include routers
app.include_router(health_router, prefix="/api/v1", dependencies=[Depends(get_db)])
app.include_router(config_router, prefix="/api/v1", dependencies=[Depends(get_db)])
app.include_router(resumes_router, prefix="/api/v1", dependencies=[Depends(get_db)])
app.include_router(jobs_router, prefix="/api/v1", dependencies=[Depends(get_db)])
app.include_router(enrichment_router, prefix="/api/v1", dependencies=[Depends(get_db)])
