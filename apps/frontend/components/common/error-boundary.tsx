...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex flex-col items-center justify-center p-8 bg-zinc-50">
          <div className="max-w-md w-full bg-white border border-black p-8">
            ...
            <div className="flex gap-3">
              <Button
                ...
                variant="outline"
                className="flex-1 border-black rounded-none hover:shadow-none transition-all"
              >
                {strings.tryAgain}
              </Button>
              <Button
                onClick={this.handleReload}
                className="flex-1 bg-blue-700 hover:bg-blue-800 text-white rounded-none border border-black hover:shadow-none transition-all"
              >
