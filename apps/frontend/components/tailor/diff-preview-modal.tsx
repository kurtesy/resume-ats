...
export function DiffPreviewModal({
  ...
  if (!diffSummary || !detailedChanges) {
    return (
      ...
      >
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col p-6 bg-white border border-black shadow-none">
          ...
          <div className="flex justify-end items-center gap-3 pt-4 border-t-2 border-black bg-white -mx-6 -mb-6 px-6 py-4">
            ...
            <Button variant="secondary" onClick={onConfirm} className="gap-2">
